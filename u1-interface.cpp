...
void CreerInterface()
{
    ...
    gInterface.BoutonEnregistrer = new Fl_Button(1100,560 , 100, 20, "Enregistrer");
    gInterface.BoutonEnregistrer->callback( BoutonQuitterCB, NULL );

    // Creation du bouton Reset
    gInterface.BoutonReset = new Fl_Button(1100, 620, 100, 20, "Reset");
    gInterface.BoutonReset->callback( BoutonQuitterCB, NULL );

    // Creation du bouton Quitter
    gInterface.BoutonQuitter = new Fl_Button(1100, 680, 100, 20, "Quitter");
    gInterface.BoutonQuitter->callback( BoutonQuitterCB, NULL );

    // Creation du champ de saisie module de sortie
    gInterface.ChampModuleDeSortie = new Fl_Value_Input(1050, 110 , 200, 20, "Module de sortie : ");
    ...
    gInterface.ChampProfondeur = new Fl_Value_Input(1050,170 , 200, 20, "Profondeur : ");
    ...
    gInterface.MenuFractale = new Fl_Choice( 1050, 50,100, 20, "Type Fractale : " );
